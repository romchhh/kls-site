export const en = {
  ...
  services: {
    ...
    sourcing: "Sourcing/Purchasing Service",
  ...
  costCalculation: {
    ...
    contactMethods: "Phone, Telegram, Viber, WhatsApp, Email (optional)",
    countries: {
      china: "China",
      ukraine: "Ukraine",
      poland: "Poland",
    ...
    countriesNote: "Countries from which and to which delivery",
    howToAddress: "How to address you?",
    yourName: "Your name",
  ...
  delivery: {
    ...
    ddp: "DDP/DDU Delivery",
    fba: "FBA Delivery",
    lcl: "LCL/FCL Delivery",
  },
  about: {
    title: "About Us",
  },
